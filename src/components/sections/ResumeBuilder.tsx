  ...
  return (
    <section className={`relative overflow-x-hidden ${ui.pageSection}`}>
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute left-1/2 top-0 h-[420px] w-[900px] -translate-x-1/2 rounded-full bg-orange-500/8 blur-[120px]" />
        <div className="absolute bottom-0 right-0 h-[300px] w-[500px] rounded-full bg-orange-600/6 blur-[100px]" />
      </div>
      ...
      <div className="relative mx-auto w-full max-w-[70vw] px-4 sm:px-6 lg:px-8">
        ...
        <div className={`overflow-x-hidden ${ui.card} shadow-card dark:shadow-card-dark p-0 sm:p-0`}>
          <div className="border-b border-orange-200/60 bg-gradient-to-r from-orange-50/90 via-warm-50/80 to-amber-50/60 px-6 py-6 dark:border-orange-500/10 dark:from-warm-900/80 dark:via-warm-900/60 dark:to-orange-950/40 sm:px-8 sm:py-7">
              ...
              <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <Link href={AUTH_LINKS.dashboard} className="text-blue-500 hover:text-orange-400">
                      dashboard profile
                    </Link>
                    .
                  </p>
          ...
          <div className="px-6 py-8 sm:px-8 sm:py-10 space-y-10">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white px-3 text-xs font-semibold uppercase tracking-wider text-slate-400 dark:bg-warm-900 dark:text-slate-500">
