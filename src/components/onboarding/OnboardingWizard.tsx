          ...
          {step === "prompt" && (
            <div className="space-y-4">
              <ProfileFileUpload
                ...
                hint=".txt, .md, or .json with a content field. Only you can see this prompt."
              ...
              {customPrompt && (
                <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
                  <p className="mb-2 text-xs font-medium uppercase tracking-wider text-slate-500">Preview</p>
