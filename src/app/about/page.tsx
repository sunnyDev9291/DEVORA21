          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={stat.label}
                  className="bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08] rounded-2xl p-6 text-center"
                >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {values.map((v) => (
              <div
                key={v.title}
                className="bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08] rounded-2xl p-6 hover:border-slate-300 dark:hover:border-white/[0.14] transition-all"
              >
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={label}
                className="bg-slate-100 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] text-slate-600 dark:text-slate-300 text-sm font-medium px-4 py-2 rounded-full"
              >
                {label}
              </span>
            ))}
      ...
      <section className="bg-slate-50 dark:bg-navy-950 py-16">
        <div className="max-w-xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/faq"
              className="bg-slate-200 dark:bg-white/[0.05] hover:bg-slate-300 dark:hover:bg-white/[0.08] border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white font-semibold px-7 py-3.5 rounded-xl transition-all"
            >
              Read Our FAQ
            </Link>
          </div>
