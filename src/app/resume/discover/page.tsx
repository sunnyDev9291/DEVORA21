...
const BuiltInCrawlPanel = dynamic(
  ...
  {
    loading: () => (
      <div className="rounded-3xl border border-slate-200/80 dark:border-white/[0.08] bg-white dark:bg-warm-900 p-8 animate-pulse">
...
export default function JobDiscoverPage() {
  return (
    <section className="relative overflow-hidden bg-slate-50 py-12 dark:bg-warm-950 sm:py-16">
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute left-1/2 top-0 h-[420px] w-[900px] -translate-x-1/2 rounded-full bg-orange-600/8 blur-[120px]" />
